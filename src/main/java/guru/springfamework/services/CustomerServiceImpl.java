...
public class CustomerServiceImpl implements CustomerService {
  ...
  public CustomerServiceImpl(
      final CustomerMapper customerMapper, final CustomerRepository customerRepository) {
  ...
  public CustomerDTO getCustomerByFirstName(String firstname) {
    return customerMapper.customerToCustomerDTO(
        customerRepository.findByfirstname(firstname).orElseThrow(ResourceNotFoundException::new));
  }

  @Override
  public CustomerDTO getCustomerByLastName(String lastname) {
    return customerMapper.customerToCustomerDTO(
        customerRepository.findBylastname(lastname).orElseThrow(ResourceNotFoundException::new));
  }
