...
public class CategoryControllerTest {
  ...
  public void testGetCategoryByName() throws Exception {
    ...
    mockMvc
        .perform(
            get(CategoryController.BASE_URL + "/" + NAME1).contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
  ...
  public void testGetByNameNotFound() throws Exception {
    ...
    mockMvc
        .perform(
            get(CategoryController.BASE_URL + "/Error").contentType(MediaType.APPLICATION_JSON))
