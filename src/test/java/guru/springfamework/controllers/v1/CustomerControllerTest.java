...
public class CustomerControllerTest {
  ...
  public void getAllCustomers() throws Exception {
    ...
    List<CustomerDTO> customers =
        Arrays.asList(new CustomerDTO(), new CustomerDTO(), new CustomerDTO());
  ...
  public void getCustomerByFirstName() throws Exception {
    ...
    mockMvc
        .perform(
            get(CustomerController.BASE_URL + "/firstname/Paidi")
  ...
  public void getCustomerByLastName() throws Exception {
    ...
    mockMvc
        .perform(
            get(CustomerController.BASE_URL + "/lastname/OSe")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
  ...
  public void getCustomerById() throws Exception {
    ...
    // then
    mockMvc
        .perform(get(CUSTOMER_URL_BY_ID).contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  }
  ...
  public void testDeleteCustomerById() throws Exception {
    mockMvc
        .perform(delete(CUSTOMER_URL_BY_ID).contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  ...
  public void testGetByLastNameNotFound() throws Exception {
    when(customerService.getCustomerByLastName(anyString()))
        .thenThrow(ResourceNotFoundException.class);

    mockMvc
        .perform(
            get(CustomerController.BASE_URL + "/lastname/Error")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isNotFound());
  }
  ...
  public void testGetByFirstNameNotFound() throws Exception {
    when(customerService.getCustomerByFirstName(anyString()))
        .thenThrow(ResourceNotFoundException.class);

    mockMvc
        .perform(
            get(CustomerController.BASE_URL + "/firstname/Error")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isNotFound());
  }
  ...
  public void testPatchCustomer() throws Exception {
    ...
    when(customerService.patchCustomer(anyLong(), any(CustomerDTO.class)))
        .thenReturn(returnCustomerDTO);

    mockMvc
        .perform(
            patch(CUSTOMER_URL_BY_ID)
                .contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(customerDTO)))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.firstname", equalTo(FIRST_NAME)))
  ...
  private static CustomerDTO returnCustomerDTOBuilder(CustomerDTO customerDTO) {
    CustomerDTO returnDTO =
        customerDtoBuilder(customerDTO.getFirstname(), customerDTO.getLastname());
