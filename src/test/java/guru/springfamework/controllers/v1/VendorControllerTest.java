...
public class VendorControllerTest {
  ...
  public void getAllVendors() throws Exception {
    ...
    List<VendorDTO> vendorDTOList =
        Arrays.asList(new VendorDTO(), new VendorDTO(), new VendorDTO());
  ...
  public void findByName() throws Exception {
    ...
    mockMvc
        .perform(
            get(VendorController.BASE_URL + "/name/tasty").contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
  ...
  public void testDeleteCustomerById() throws Exception {
    mockMvc
        .perform(
            delete(VendorController.BASE_URL + "/" + 1L).contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  }
